...
/*            dataGridView1.Rows.Add("a1", r.a1);
        ...
        public void pid3()
        {
            ...
            {
                dataGridView3.Rows.Add(r.Time[i], r.massdB[i], r.massdZ[i], r.massFist[i], r.massTeta[i], r.massH[i], r.massDzps[i], r.massY5[i], r.massIglz[i]);
            }
            for (int i = 0; i < r.graphTime.Count; i++)
            {
                chart1.Series[0].Points.AddXY(r.graphTime[i], r.graphH[i]);
            }
            }
